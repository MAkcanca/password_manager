...
namespace SifreYoneticisi
{
    ...
    public class PasswordStrength
    {
        ...
        private void CheckPasswordWithDetails(string pwd)
        {
            ...
            if (nScore >= 0 && nScore < 20) { sComplexity = "Çok Zayıf"; }
            else if (nScore >= 20 && nScore < 40) { sComplexity = "Zayıf"; }
            else if (nScore >= 40 && nScore < 60) { sComplexity = "İyi"; }
            else if (nScore >= 60 && nScore < 80) { sComplexity = "Güçlü"; }
            else if (nScore >= 80 && nScore <= 100) { sComplexity = "Çok Güçlü"; }
